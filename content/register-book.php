				...
				<div class="box-body">
					...
					<div class="col-sm-6 col-md-6 col-ls-12">
						...
						<div class="form-group">
							...
							<input type="date" name="launchdate" class="form-control" placeholder="Launch date" required="required">
						</div>
						<div class="form-group">
							<label>Language <span class="text-red">*</span></label>
							<input type="text" name="language" class="form-control" placeholder="Language" required="required">
						</div>
					</div>
					...
					<div class="col-sm-6 col-md-6 col-ls-12">
						<div class="form-group">
							...
							<input type="number" name="isbn" class="form-control" placeholder="ISBN" required="required">
						</div>
						<div class="form-group">
							<label>Edition <span class="text-red">*</span></label>
							<input type="number" name="edition" class="form-control" placeholder="Edition" required="required">
						</div>
						<div class="form-group">
							<label>Page <span class="text-red">*</span></label>
							<input type="number" name="page" class="form-control" placeholder="Page" required="required">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="number" name="readingtime" class="form-control" placeholder="Reading time" required="required">
						</div>
					</div>
					...
					<div class="box-footer">
						...
						<button type="submit" name="registerBook" class="btn btn-primary pull-right">Registrer</button>
